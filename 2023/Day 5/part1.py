...
def populate_mapper(mapper, source_start, dest_start, range_length):
    for i in range(range_length):
        mapper[dest_start + i] = source_start + i

def seed_to_soil(seed):
    if seed_to_soil_map.get(seed) is None:
        return seed
    else:
        return seed_to_soil_map[seed]
